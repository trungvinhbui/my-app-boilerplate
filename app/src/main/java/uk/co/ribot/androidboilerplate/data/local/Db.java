package uk.co.vinhbpt.myappboilerplate.data.local;
...
import uk.co.vinhbpt.myappboilerplate.data.model.Name;
import uk.co.vinhbpt.myappboilerplate.data.model.Profile;
